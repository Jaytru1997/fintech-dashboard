...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t bg-background-dark font-medium text-white [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-gray-800 transition-colors hover:bg-background-dark data-[state=selected]:bg-background-dark text-white",
      className
    )}
    {...props}
  />
