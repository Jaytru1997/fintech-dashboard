...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background-darkest">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 sm:pt-32 sm:pb-24">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <span className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium tracking-wide">
            ...
            >
              <Link href="/auth/register" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="group w-full sm:w-auto px-8 py-6 text-base sm:text-lg font-semibold bg-gradient-to-r from-primary to-primary-dark hover:from-primary-dark hover:to-primary shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all duration-300"
                >
                  Get Started Free
              ...
              <Link href="/auth/login" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto px-8 py-6 text-base sm:text-lg font-semibold border-2 border-gray-700 hover:border-primary/60 hover:bg-primary/5 transition-all duration-300"
                >
                  Sign In
                </Button>
              </Link>
      ...
      {/* Stats Section */}
      <section className="relative w-full border-t border-gray-800/50 bg-background-darker/30">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12">
            {stats.map((stat, index) => {
              ...
              return (
                ...
                >
                  <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-primary/15 to-blue/15 mb-4 border border-primary/10">
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ duration: 0.5, delay: index * 0.1, ease: "easeOut" }}
                >
                  <Card className="group relative h-full overflow-hidden border border-gray-800/50 bg-background-darker/50 hover:border-primary/40 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5">
      ...
      {/* CTA Section */}
      <section className="relative w-full border-t border-gray-800/50 bg-background-darker/50">
